import { calculateSequenceDuration, calculateTotalFrames } from "../src/core/timing.js";
...
describe("Timing Utils", () => {
    ...
    test("calculateSequenceDuration returns correct frames for a long text", () => {
        ...
        const text = "This is a much longer text that has exactly nineteen words to test the duration calculation logic correctly now.";
