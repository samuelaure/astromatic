...
const TransitioningText = ({ text, startFrame, duration, type = "default" }) => {
    ...
    const opacity = interpolate(relativeFrame, [0, 5, duration - 5, duration], [0, 1, 1, 0]);
    const scale = type === "hook"
        ...
        <AbsoluteFill style={{ backgroundColor: "#0f172a" }}>
            ...
            <Sequence from={0} durationInFrames={hookDuration}>
                <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
                    <TransitioningText text={hook} startFrame={0} duration={hookDuration} type="hook" />
                </AbsoluteFill>
            </Sequence>
            ...
            <Sequence from={t1} durationInFrames={problemDuration}>
                <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
                    <TransitioningText text={problem} startFrame={t1} duration={problemDuration} />
                </AbsoluteFill>
            </Sequence>
            ...
            <Sequence from={t2} durationInFrames={solutionDuration}>
                <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
                    <TransitioningText text={solution} startFrame={t2} duration={solutionDuration} />
                </AbsoluteFill>
            </Sequence>
            ...
            <Sequence from={t3} durationInFrames={ctaDuration}>
                <AbsoluteFill style={{ justifyContent: "center", alignItems: "center" }}>
                    <TransitioningText text={cta} startFrame={t3} duration={ctaDuration} type="cta" />
                </AbsoluteFill>
            </Sequence>
        </AbsoluteFill>
    );
